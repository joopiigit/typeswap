...
{
    [CONTEST_CATEGORY_COOL]   = SPECIES_BULBASAUR,
    [CONTEST_CATEGORY_BEAUTY] = SPECIES_BULBASAUR,
    [CONTEST_CATEGORY_CUTE]   = SPECIES_BULBASAUR,
    [CONTEST_CATEGORY_SMART]  = SPECIES_BULBASAUR,
    [CONTEST_CATEGORY_TOUGH]  = SPECIES_BULBASAUR
};
